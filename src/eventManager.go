...
func addCustomEvent() {
	...
	event.SetStartAt(time.Date(2026, time.May, 1, 6, 0, 0, 0, time.FixedZone("Europe/Paris", 0)))
	event.SetEndAt(time.Date(2026, time.May, 1, 16, 0, 0, 0, time.FixedZone("Europe/Paris", 0)))
